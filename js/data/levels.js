const Levels = [
    ...
    },
    {
        ...
        world: 2,
        name: 'Fix the Labels',
        description: 'Try using Space + ? to see the keymaps. You can match (m) inside (i) word (w) to select text inside quotes, then d to delete. Alternative approach is to use w to select word. Note that you can revert to character selection using ;',
        commands: ['m', 'i', 'w', 'd'],
        par: 4,
        wizard: 3,
